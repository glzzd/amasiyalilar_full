  ...
  return (
    <div className="max-w-5xl mx-auto pb-10">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Haqqımızda Səhifəsi</h1>
          <p className="text-gray-500 text-sm mt-1">Saytın haqqımızda səhifəsinin məzmununu idarə edin</p>
        </div>
        <button
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Missiya</label>
                <textarea
                  name="mission"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Vizyon</label>
                <textarea
                  name="vision"
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Maddələr (Bullets)</h2>
            <button
          ...
          <div className="space-y-3">
            ...
            {formData.bullets.length === 0 && (
              <p className="text-sm text-gray-500 text-center py-4">Hələ heç bir maddə əlavə edilməyib</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-3">
            ...
            {formData.stats.length === 0 && (
              <p className="text-sm text-gray-500 text-center py-4">Hələ heç bir statistika əlavə edilməyib</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Komanda Üzvləri</h2>
            <button
          ...
          <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-gray-200 rounded-lg px-3 py-1.5 text-gray-900 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    <label className="block text-xs text-gray-500 mb-1">Vəzifə</label>
                    <input
                      type="text"
                      value={member.role}
                    ...
                    <div className="flex gap-2">
                      <div className="relative flex-1">
                        <input
                          ...
                          placeholder="URL"
                          className="w-full bg-white border border-gray-200 rounded-lg px-3 py-1.5 text-gray-900 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 pr-8"
                        />
            ...
            {formData.team.length === 0 && (
              <p className="text-sm text-gray-500 text-center py-4">Hələ heç bir komanda üzvü əlavə edilməyib</p>
            )}
          </div>
        </div>
      </div>
