...
import { ArrowLeft, MapPin, Calendar, Award, Activity, Lightbulb, Users } from 'lucide-react'
import allAthletes from '../../mockDatas/allAthletes.json'

const AthletDetailsPage = () => {
  ...
  const athlete = useMemo(() => {
    return Array.isArray(allAthletes) ? allAthletes.find((item) => item.slug === slug) : null
  }, [slug])
  ...
  if (!athlete) {
    return (
      <div className="container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-gray-500 mt-2">Axtardığınız idmançı haqqında məlumat mövcud deyil.</p>
        <Link
          to="/amasiyalilar/athletes"
          ...
          <div className="lg:col-span-8 space-y-12">
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                Həyatı və İdman Karyerası
              </h2>
              <div className="prose prose-lg text-gray-600 leading-relaxed max-w-none">
                <p>{athlete.biography || athlete.description}</p>
              </div>
            </section>
            ...
            {athlete.clubs && athlete.clubs.length > 0 && (
              <section>
                <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  ...
                  İştirak Etdiyi Klublar
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {athlete.clubs.map((club, index) => (
                    <div
                      key={index}
              ...
              <div className="space-y-6">
                {athlete.sport && (
                  <div>
                    ...
                    <div className="text-gray-900 font-medium">{athlete.sport}</div>
                  </div>
                )}
                ...
                {athlete.discipline && (
                  <div>
                    ...
                    <div className="text-gray-900 font-medium">{athlete.discipline}</div>
                  </div>
                )}

                {athlete.interesting_facts && athlete.interesting_facts.length > 0 && (
                  <div>
                    <div className="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-2 flex items-center gap-2">
                      <Lightbulb size={14} />
                      Maraqlı Faktlar
                    ...
                    <ul className="space-y-3">
                      {athlete.interesting_facts.map((fact, i) => (
...
export default AthletDetailsPage
