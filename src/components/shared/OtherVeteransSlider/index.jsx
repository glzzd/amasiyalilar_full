  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-2xl font-bold text-gray-900">Digər Qazilərimiz</h3>
      ...
      <div className="overflow-hidden">
        ...
        >
          {others.map((veteran) => (
            ...
            >
              <Link to={`/veterans/${veteran.slug}`} className="block group/card h-full">
                <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <h4 className="font-bold text-gray-900 text-lg mb-1 line-clamp-1 group-hover/card:text-blue-600 transition-colors">
                      {veteran.fullName}
                    </h4>
...
export default OtherVeteransSlider
